...
.get(parseUrlencoded, parseJSON, function (request, response) {
  ...
  if(student){
    ...
    console.log("studentNum: " + student.studentFindInfo);
    //var regexExpression = new RegExp("/^" + studentNum + "/");
    models.Students.find({"number": student.studentFindInfo}, function(error, students){
      if(error) response.send(error);
